...
def progress():
    ...
    if tsal==1:
        ...
        Tsal.place(relx=0.5,rely=0.07, anchor="n")
    #TemperaturMotor 
    temperature1 = Label(text=tempMotor, font=("Century Gothic", 80), bg="black", fg="White")
    temperature1.place(relx=0.7, rely=0.9, anchor="sw")


    #Batteri Status HV
    batteristatus = Label(text=hv_verdi, font=("Century Gothic", 80), bg="black", fg="White")
    batteristatus.place(relx=0.8, rely=0.45, anchor="sw")
    
    #Batteri status 12v
    batteri12v = Label(text=verdi_12v, font=("Century Gothic", 80), bg="black", fg="White")
    batteri12v.place(relx=0.8, rely=0.70, anchor="sw")
    
    #Hastighet
    speed_digits = Label(text=speed, font=("Century Gothic", 320), bg="black", fg="White")
